  ...
  return (
    <section className="container-custom py-16 md:py-24 bg-white min-h-screen">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-5xl md:text-6xl font-bold text-[#111111] mb-12">
          Terms of Service
        </h1>

        <div className="space-y-8 text-[#4B5563] leading-relaxed">
          <div>
            <h2 className="text-2xl font-bold text-[#111111] mb-4">1. Service Description</h2>
            <p>
            ...
            <p className="mt-3">
              <strong className="text-[#111111]">We are an independent consultancy and are not affiliated with La Marzocco, Slayer, or their parent companies.</strong>
            </p>
          </div>

          <div>
            <h2 className="text-2xl font-bold text-[#111111] mb-4">2. Accuracy & Methodology</h2>
            <p className="mb-4">
            ...
            <p>
              <strong className="text-[#111111]">Limitation:</strong> We cannot account for user error in mixing, uncalibrated scales, or changes in your source water supply.
            </p>
          </div>

          <div>
            <h2 className="text-2xl font-bold text-[#111111] mb-4">3. Limitation of Liability</h2>
            <p>
          ...
          <div>
            <h2 className="text-2xl font-bold text-[#111111] mb-4">4. Data Accuracy</h2>
            <p>
          ...
          <div>
            <h2 className="text-2xl font-bold text-[#111111] mb-4">5. Refund Policy</h2>
            <p>
          ...
          <div>
            <h2 className="text-2xl font-bold text-[#111111] mb-4">6. Intellectual Property</h2>
            <p>
          ...
          <div>
            <h2 className="text-2xl font-bold text-[#111111] mb-4">7. Contact</h2>
            <p>
          ...
          <div className="bg-[#F9FAFB] border border-[#E5E7EB] rounded-[4px] p-6 mt-12">
